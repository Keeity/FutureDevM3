...
class UserController {
    async findAll(request, response) {
        ...
        const data = await User.findAll({attributes: ['id', 'name', 'email']}) //coloca um objeto e dentro de atributos passa um array, para não colocar dados sensíveis do usuário, como senha.
